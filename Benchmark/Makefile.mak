...
all:: parallelCal vectorMultiply externalCal test1 test2 test3 test4 test5 multitest1
...
clean:
	rm -rf parallelCal vectorMultiply externalCal test1 test2 test3 test4 test5 multitest1 *.o ./record/
